...
public class CommandLogger {
    ...
    /**
     * Write a message to the player who issued the command or the server console with the command's
     * message output. This is used only for logging command results, which is why there's no usage
     * of Bukkit's Logger where log levels can be manually set.
